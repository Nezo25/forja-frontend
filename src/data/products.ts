...
export const products: Product[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1613771404784-63a9eeed2e30?w=600&h=700&fit=crop&auto=format',
    printTimeH: 18,
    filamentG: 320,
    active: true,
    featured: true,
  },
  {
    ...
    basePrice: 89,
    finishOptions: FINISH_OPTIONS,
    image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=600&h=700&fit=crop&auto=format',
    printTimeH: 10,
    filamentG: 180,
    active: true,
    featured: true,
  },
  {
    ...
    basePrice: 349,
    finishOptions: FINISH_OPTIONS,
    image: 'https://images.unsplash.com/photo-1606041008023-472dfb5e530f?w=600&h=700&fit=crop&auto=format',
    printTimeH: 42,
    filamentG: 780,
    active: true,
    featured: true,
  },
  {
    ...
    basePrice: 79,
    finishOptions: FINISH_OPTIONS,
    image: 'https://images.unsplash.com/photo-1600861194942-f883de0dfe96?w=600&h=700&fit=crop&auto=format',
    printTimeH: 8,
    filamentG: 140,
    active: true,
  },
  {
    ...
    basePrice: 229,
    finishOptions: FINISH_OPTIONS,
    image: 'https://images.unsplash.com/photo-1501854140801-50d01698950b?w=600&h=700&fit=crop&auto=format',
    printTimeH: 28,
    filamentG: 520,
    active: true,
  },
  {
    ...
    basePrice: 55,
    finishOptions: FINISH_OPTIONS,
    image: 'https://images.unsplash.com/photo-1518791841217-8f162f1912da?w=600&h=700&fit=crop&auto=format',
    printTimeH: 6,
    filamentG: 95,
    active: true,
  },
  {
    ...
    basePrice: 419,
    finishOptions: FINISH_OPTIONS,
    image: 'https://images.unsplash.com/photo-1614680376593-902f74cf0d41?w=600&h=700&fit=crop&auto=format',
    printTimeH: 56,
    filamentG: 960,
    active: true,
  },
  {
    ...
    basePrice: 38,
    finishOptions: FINISH_OPTIONS,
    image: 'https://images.unsplash.com/photo-1484704849700-f032a568e944?w=600&h=700&fit=crop&auto=format',
    printTimeH: 3,
    filamentG: 60,
    active: true,
  },
  {
    ...
    basePrice: 289,
    finishOptions: FINISH_OPTIONS,
    image: 'https://images.unsplash.com/photo-1614680376408-81e91ffe3db7?w=600&h=700&fit=crop&auto=format',
    printTimeH: 34,
    filamentG: 610,
    active: false,
  },
